...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Laporan Pembayaran Kas</div>
    </div>
</div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-7">
                            ...
                            <div class="input-group">
                                ...
                                <button type="submit" class="btn btn-info filter" onclick="ViewLaporanPembayaran()"><i class="fas fa-search"></i></button>
                                <button type="submit" class="btn btn-danger reload"><i class="fas fa-sync-alt"></i></button>
                            </div>
                        </div>
                    </div>
                    <div id="laporan-pembayaran">
                    </div>
                </div>
            </div>
        </div>
